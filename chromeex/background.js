...
async function fetchCommentsBundle(fileId, token) {
  ...
  do {
    ...
    console.log('[background] comments page:', {
...
// Prefer the ACTIVE Doc (mirrors the "working" file)
...
async function handleScrapeAndComments(sendResponse) {
  try {
    ...
    // Use the ACTIVE Doc like the working version
    ...
    const revision = {
      ...
      finalDocumentText: rev.finalDocumentText || ''
    };
