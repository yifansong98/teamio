...
const ReflectionsPage = () => {
  ...
  const [userIdsToFullName, setUserIdsToFullName] = useState(null)
...
return (
  <div className="bg-gray-50 min-h-screen">
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
            <button onClick={() => navigate("/teamio")} className="text-blue-600 hover:underline mb-6">&larr; Back to Dashboard</button>
      ...
      <div className="mt-8">
        ...
        {!loading && !error && activeTab === "equitable" && (
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">The pie charts below illustrate how contributions were distributed across tools. A single unit corresponds to an edit in Google Docs.</p>
