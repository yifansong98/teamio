  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex justify-center mt-8">
        <button onClick={() => navigate("/teamio/reflections", { state: { teamId } })} className="px-6 py-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors">Done & Go to Reflections</button>
      </div>
